    ...
    <body>
                                    ...
                                    <div class="aiia-wizard-step <?php echo (isset($_GET['complete'])?'active':'') ?>">
                                        ...
                                        <div class="step-content step-five">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <h3 class="title text-center margin"><?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?>  </h3> 
        ...
        <footer class="footer text-center">
            <div class="container fText">
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <div class="row">
                        <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://www.bdtask.com/">bdtask</a> | <?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </div>
