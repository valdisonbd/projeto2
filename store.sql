...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Jan-2023 às 11:46
...
(1, 'Product', 'create', 'product ID :1', '1', '2023-01-24 00:07:57');
...
--
-- Estrutura da tabela `acc_customer_income`
--
...
--
-- Estrutura da tabela `acc_glsummarybalance`
--
...
--
-- Estrutura da tabela `acc_income_expence`
--
...
--
-- Estrutura da tabela `country_state_city`
--
...
--
-- Extraindo dados da tabela `country_state_city`
--
...
--
-- Estrutura da tabela `customer_gurrantor_map`
--
...
--
-- Estrutura da tabela `lease_product_map`
--
...
--
-- Estrutura da tabela `lease_store_map`
--
...
--
-- Estrutura da tabela `payment_collection`
--
...
(1, 'pro-1001', 'usado-completo-celta', '1', '1', '1', '1', 'bom estado', 0, 0, 0, 0, 1, '1', '2023-01-24 00:07:57', '', '0000-00-00 00:00:00');
...
INSERT INTO `product_brand` (`brand_id`, `brand_name`, `isactive`) VALUES
(1, 'completo', 1);
...
--
-- Estrutura da tabela `product_model`
--
...
--
-- Extraindo dados da tabela `product_model`
--

INSERT INTO `product_model` (`model_id`, `model_name`, `isactive`) VALUES
(1, 'celta', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `product_unit`
--
...
--
-- Extraindo dados da tabela `product_unit`
--

INSERT INTO `product_unit` (`unit_id`, `unit_name`, `isactive`) VALUES
(1, 'chevrolet', 1);
...
--
-- Estrutura da tabela `purchase_receive`
--
...
--
-- Estrutura da tabela `purchase_receive_details`
--
...
--
-- Estrutura da tabela `purchase_return`
--
...
--
-- Estrutura da tabela `purchase_return_details`
--
...
--
-- Estrutura stand-in para vista `recovery_list`
...
--
-- Estrutura da tabela `sales_parent`
--
...
--
-- Estrutura da tabela `sales_return`
--
...
--
-- Estrutura da tabela `sales_return_details`
--
...
--
-- Extraindo dados da tabela `sale_type`
--
...
--
-- Extraindo dados da tabela `sec_role`
--
...
--
-- Extraindo dados da tabela `sec_userrole`
--
...
(2, 'Multi Store Management', '98 Green Road, Farmgate, Dhaka-1215.', 'bdtask@gmail.com', '0123456789', 'assets/img/icons/logo.png', 'assets/img/icons/m.png', '0', 'LTR', '2017Â©Copyright');
...
--
-- Estrutura da tabela `stock_movement_details`
--
...
--
-- Estrutura stand-in para vista `stoere_overdue`
-- (Veja abaixo para a view atual)
--
...
--
-- Extraindo dados da tabela `synchronizer_setting`
--
...
--
-- Estrutura da tabela `tmp_store_stock`
--
...
--
-- Estrutura da tabela `treeview_items`
--
...
(1, NULL, NULL, NULL, 'valdisonbd@gmail.com', 'b3133646b71b68c17a648a89ea85430c', NULL, NULL, '2023-01-25 21:44:32', '2023-01-24 13:37:49', '::1', 1, 1, NULL);
...
--
-- Índices para tabela `acc_customer_income`
--
ALTER TABLE `acc_customer_income`
  ADD UNIQUE KEY `ID` (`ID`);

--
-- Índices para tabela `acc_glsummarybalance`
--
ALTER TABLE `acc_glsummarybalance`
  ADD UNIQUE KEY `ID` (`ID`);

--
-- Índices para tabela `acc_income_expence`
--
...
--
-- Índices para tabela `customer_gurrantor_map`
--
...
--
-- Índices para tabela `lease`
--
ALTER TABLE `lease`
  ADD PRIMARY KEY (`lease_id`);

--
-- Índices para tabela `lease_product_map`
--
...
--
-- Índices para tabela `lease_store_map`
--
...
--
-- Índices para tabela `payment_collection`
--
...
--
-- Índices para tabela `product_model`
--
...
--
-- Índices para tabela `product_unit`
--
...
--
-- Índices para tabela `purchase_order`
--
ALTER TABLE `purchase_order`
  ADD PRIMARY KEY (`po_no`);

--
-- Índices para tabela `purchase_order_details`
--
...
--
-- Índices para tabela `purchase_receive`
--
...
--
-- Índices para tabela `purchase_receive_details`
--
ALTER TABLE `purchase_receive_details`
  ADD KEY `fk_receive_id` (`receive_id`);

--
-- Índices para tabela `purchase_return`
--
...
--
-- Índices para tabela `sales_parent`
--
...
--
-- Índices para tabela `sales_return`
--
...
--
-- Índices para tabela `stock_movement_details`
--
...
--
-- Índices para tabela `synchronizer_setting`
--
...
--
-- AUTO_INCREMENT de tabela `accesslog`
--
ALTER TABLE `accesslog`
  MODIFY `sl_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `acc_customer_income`
--
ALTER TABLE `acc_customer_income`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `acc_glsummarybalance`
--
ALTER TABLE `acc_glsummarybalance`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `acc_income_expence`
--
ALTER TABLE `acc_income_expence`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `customer_gurrantor_map`
--
ALTER TABLE `customer_gurrantor_map`
...
--
-- AUTO_INCREMENT de tabela `gurrantor`
--
ALTER TABLE `gurrantor`
...
--
-- AUTO_INCREMENT de tabela `lease_product_map`
--
ALTER TABLE `lease_product_map`
  MODIFY `row_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `lease_store_map`
--
ALTER TABLE `lease_store_map`
  MODIFY `row_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `payment_collection`
--
ALTER TABLE `payment_collection`
...
--
-- AUTO_INCREMENT de tabela `sales_parent`
--
ALTER TABLE `sales_parent`
...
--
-- AUTO_INCREMENT de tabela `sale_type`
--
ALTER TABLE `sale_type`
...
--
-- AUTO_INCREMENT de tabela `synchronizer_setting`
--
ALTER TABLE `synchronizer_setting`
...
--
-- Limitadores para a tabela `stock_movement_details`
--
ALTER TABLE `stock_movement_details`
